                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-between mb-5">
                                        ...
                                        <a href="tambah_product.php" class="btn btn-brown" style="background-color: #66320D; color:#ffff;"> <i class="bx bx-plus me-2"></i>Tambah </a>
                                    </div>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td width="10" data-label="Name_product"> <?php echo $name_product; ?></td>
                                                        <td width="15" data-label="Material_product"> <?php echo $material_product; ?></td>
                                                        <td width="10" data-label="Price_product">$ <?php echo $price_product; ?></td>
                                                        <td width="50" data-label="Images_product">
                                                            <img src="../image/<?php echo $images_product; ?>" style="width: 100%;">
                                                        </td>
                                                        <td width="10" data-label="Aksi">
                                                            <a href="edit_product.php?data=<?php echo $kode_product; ?>" class="btn editbtn" style="border-color: #66320D; color:#66320D;"> <i class="fas fa-edit me-2"></i>Edit</a>
                                                            <a href="javascript:if(confirm('Anda yakin ingin menghapus data?
                  <?php echo $name_product; ?>?'))	window.location.href = 'product.php?aksi=hapus&data=<?php echo
                                                                                                            $kode_product; ?>'" class="btn deletebtn" style="border-color: #c72929; color:#c72929;"><i class="fas fa-trash me-2"></i>Delete</a>
